...
class AtomEncoder(torch.nn.Module):
    """
    Custom wrapper around an instance of :class:`nn.Module` to embed atoms.
    """

    def __init__(self, hidden_channels: int) -> None:
        """
        Initialize the instance with the hidden channels.
    ...
    def forward(self, x: torch.Tensor) -> torch.Tensor:
        """
        Forward pass to embed the input atom.

        @param x: Input atom.
        @return: Embedding of the input atom.
        """
        if x.dim() == 1:
            x = x.unsqueeze(1)
...
class BondEncoder(torch.nn.Module):
    """
    Custom wrapper around an instance of :class:`nn.Module` to embed bonds.
    """
    ...
    def forward(self, edge_attr: torch.Tensor) -> torch.Tensor:
        """
        Forward pass to embed the edge attribute of the bond.

        @param edge_attr: Edge attribute of the bond.
        @return: Embedding of the input edge attribute.
        """
        if edge_attr.dim() == 1:
...
class Net(torch.nn.Module):
    """
    Custom wrapper around an instance of :class:`nn.Module` to create a GNN.
    """
    ...
    def __init__(
        ...
        @param num_layers: Number of layers inside the GNN.
        @param dropout: Dropout. Defaults to 0.0.
        @param inter_message_passing: Activates the HO GNN. Defaults to True.
        """
    ...
    def forward(self, data: torch.Tensor) -> torch.Tensor:
        ...
        @param data: Input atoms.
        @return: Result of forward iteration.
        """
